...
const app = createApp({
    ...
    setup() {
        ...
        const {
            paged,
            apiUrl
        } = usePagedList('/CustomerGroup/GetPagedCustomerGroup', ``)
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        ...
                        const response = await request('delete', `/CustomerGroup/DeleteCustomerGroup`, {
        ...
        const handleSubmitForm = async () => {
            ...
            try {
                const response = await request(
                    'post',
                    pageMode.create ? '/CustomerGroup/CreateCustomerGroup' : '/CustomerGroup/UpdateCustomerGroup',
                    {
        ...
        const handleTableActionRowClick = async (payload) => {
            ...
            //load child
            pagedChild.data = payload.customerSubGroups
        ...
        const handleSubmitFormChild = async () => {
            ...
            try {
                ...
                if (childMode.create) {
                    url = '/CustomerSubGroup/CreateCustomerSubGroup'
                } else if (childMode.update) {
                    url = '/CustomerSubGroup/UpdateCustomerSubGroup'
                } else if (childMode.delete) {
                    url = '/CustomerSubGroup/DeleteCustomerSubGroup'
                    method = 'delete'  
                }
                ...
                const response = await request(
                    ...
                    url,
                    {
                        ...
                        customerGroupId: paged.selectedRow.id
                    }
                )
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        await getDataTable()
                        pagedChild.data = paged.data.find(item => item.id === paged.selectedRow.id)?.customerSubGroups                        
