...
const app = createApp({
    ...
    setup() {
        ...
        const columns = ref([
            ...
            { columnKey: 'symbol', columnName: 'Symbol', columnCaption: 'Symbol', columnSort: 'Symbol' },
            { columnKey: 'description', columnName: 'Description', columnCaption: 'Description', columnSort: 'Description' },
        ])
        const {
            paged,
            apiUrl
        } = usePagedList('/Currency/GetPagedCurrency', ``)
        ...
        const handleClickCreate = () => {
            ...
            paged.selectedRow = {}
            Object.assign(formData, { id: null, name: null, symbol: null, description: null })
        }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        ...
                        const response = await request('delete', `/Currency/DeleteCurrency`, {
                        ...
                        if (response?.data?.code === 200) {
                            ...
                            await getDataTable()
                            Object.assign(paged.selectedRow, { id: null, name: null, symbol: null, description: null })
        ...
        const handleSubmitForm = async () => {
            ...
            try {
                const response = await request(
                    'post',
                    pageMode.create ? '/Currency/CreateCurrency' : '/Currency/UpdateCurrency',
                    {
        ...
        const odataFilter = computed(() => {
            const filters = [
                ...
                `contains(tolower(Symbol), '${paged.searchValue}')`,
