...
const app = createApp({
    ...
    setup() {
        ...
        const columns = ref([
            ...
            { columnKey: 'vendorGroupName', columnName: 'VendorGroupName', columnCaption: 'VendorGroupName', columnSort: 'VendorGroup.Name' },
        ])
        const {
            paged,
            apiUrl
        } = usePagedList('/VendorSubGroup/GetPagedVendorSubGroup', ``)
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        ...
                        const response = await request('delete', `/VendorSubGroup/DeleteVendorSubGroup`, {
                            id: paged.selectedRow.id,
                            userId: userId.value,
                            vendorGroupId: paged.selectedRow.vendorGroupId
                        })
        ...
        const formValidation = () => {
            ...
            if (!formData.vendorGroupId) {
                errorData.vendorGroupId = 'Vendor Group is required.'
                valid = false
            }
        ...
        const handleSubmitForm = async () => {
            ...
            try {
                const response = await request(
                    'post',
                    pageMode.create ? '/VendorSubGroup/CreateVendorSubGroup' : '/VendorSubGroup/UpdateVendorSubGroup',
                    {
        ...
        const preparePage = async () => {
            ...
            await getDataTable()
            const response = await request('get', '/VendorGroup/GetVendorGroupLookup', {})
            vendorGroupLookup.value = response?.data?.content?.data
            setTimeout(() => {
